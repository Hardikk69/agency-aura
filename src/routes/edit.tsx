  ...
  const clips = [
    {
      ...
      poster: "https://framerusercontent.com/images/FHS0pgop7yjZHlGI56VGYUZULS0.png?width=260&height=462",
      subtitle: "Wait... how did I get 10M views?"
    },
    {
      video: "https://framerusercontent.com/assets/9d7Q1tAYAEPaUo7PQrKcC2G00Qg.mp4",
      poster: "https://framerusercontent.com/images/4kp2KImAJicjmXIczDErqcpt9FI.png?width=528&height=938",
      subtitle: "It all starts in the first 0.8 seconds."
    },
    {
      video: "https://framerusercontent.com/assets/5rWhVdIvfX2ypMArjXiZ5ZIbyQ.mp4",
      poster: "https://framerusercontent.com/images/RJn1eKEVAnvuDEpP5MAM11elvU.png?width=260&height=462",
    ...
    <div className="w-full h-full bg-[#1b1b1e]/85 backdrop-blur-2xl rounded-2xl border border-white/[0.12] shadow-2xl shadow-black/30 ring-1 ring-white/[0.05] p-3 flex flex-col justify-between overflow-hidden relative select-none font-mono text-[9px] text-[#8e8e93]">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-white/5">
        <div className="flex items-center gap-1.5">
          <span className="h-2.5 w-2.5 rounded-full bg-[#ff5f56] cursor-pointer" onClick={() => setIsPlaying(!isPlaying)} />
          <span className="h-2.5 w-2.5 rounded-full bg-[#ffbd2e]" />
          <span className="h-2.5 w-2.5 rounded-full bg-[#27c93f]" />
        </div>
        <span className="text-[10px] tracking-wide text-neutral-300 font-medium">
          Adobe After Effects 2026 — <em className="text-[#ff4d31] not-italic font-semibold">Vertex_Edit.aep</em> *
        </span>
        <div className="flex items-center gap-2">
          <span className="px-1.5 py-0.5 rounded bg-[#ff4d31]/10 text-[#ff4d31] text-[8px] font-bold uppercase tracking-wider animate-pulse">Render Queue</span>
        </div>
      </div>
      ...
      <div className="flex gap-2 my-2 flex-grow h-[270px] justify-between overflow-hidden">
        ...
        <div className="h-full aspect-[9/16] bg-[#111113] border border-white/5 rounded p-1 flex flex-col justify-between relative overflow-hidden flex-shrink-0 mx-auto">
          ...
          <div className="absolute top-1 left-1.5 right-1.5 flex items-center justify-between text-[7px] text-neutral-500 z-30 pointer-events-none">
            <span className="bg-black/60 px-1 py-0.5 rounded border border-white/5 truncate">Comp_01</span>
            <span className="bg-black/60 px-1 py-0.5 rounded border border-white/5 text-[#ff4d31] font-bold">50.0%</span>
          </div>
      ...
      <div className="bg-[#17171a] border border-white/5 rounded p-2 flex flex-col h-[180px] relative">
        ...
        <div className="flex items-center justify-between pb-1.5 border-b border-white/5 mb-2 text-[8px]">
          <div className="flex items-center gap-1">
            <span className="bg-[#1b1b1e] text-[#ff4d31] px-2 py-0.5 rounded-t border-t border-x border-white/10 font-bold">Comp 1</span>
          ...
          <div className="w-[45%] flex flex-col justify-between border-r border-white/5 pr-2">
            <div className="flex flex-col text-[7.5px] text-neutral-500">
              ...
              <div className="flex items-center h-6 border-b border-white/[0.02]">
                ...
                <span className="w-12 text-center text-neutral-600 font-bold font-mono">🔕 🔴 🔓</span>
              ...
              <div className="flex items-center h-6">
                ...
                <span className="w-12 text-center text-green-400 font-bold font-mono">🔊 🔲 🔒</span>
                <span className="flex-grow text-right text-neutral-400">Normal</span>
              </div>
            </div>
          ...
          <div className="w-[55%] flex flex-col justify-between relative pl-2 overflow-hidden">
            ...
            <div className="flex-grow space-y-1.5 relative flex flex-col justify-center">
              ...
              <div className="h-6 w-full bg-white/[0.01] rounded border border-white/5 flex items-center relative">
                ...
                <span
                  className={cn("absolute text-[12px] font-extrabold transition-all duration-300 font-sans cursor-pointer",
                    isKeyframeActive(10) ? "text-yellow-400 drop-shadow-[0_0_8px_#facc15] scale-125" : "text-neutral-600 hover:text-white"
                  )}
                  style={{ left: "10%" }}
                >
                  ◆
                ...
                <span
                  className={cn("absolute text-[12px] font-extrabold transition-all duration-300 font-sans cursor-pointer",
                    isKeyframeActive(40) ? "text-yellow-400 drop-shadow-[0_0_8px_#facc15] scale-125" : "text-neutral-600 hover:text-white"
                  )}
                  style={{ left: "40%" }}
                >
                  ◆
                ...
                <span
                  className={cn("absolute text-[12px] font-extrabold transition-all duration-300 font-sans cursor-pointer",
                    isKeyframeActive(75) ? "text-yellow-400 drop-shadow-[0_0_8px_#facc15] scale-125" : "text-neutral-600 hover:text-white"
                  )}
                  style={{ left: "75%" }}
                >
                  ◆
              ...
              <div className="h-6 w-full bg-white/[0.01] rounded border border-white/5 flex items-center relative">
                <span
                  className={cn("absolute text-[12px] font-extrabold transition-all duration-300 font-sans cursor-pointer",
                    isKeyframeActive(20) ? "text-cyan-400 drop-shadow-[0_0_8px_#22d3ee] scale-125" : "text-neutral-600 hover:text-white"
                  )}
                  style={{ left: "20%" }}
                >
                  ◆
                ...
                <span
                  className={cn("absolute text-[12px] font-extrabold transition-all duration-300 font-sans cursor-pointer",
                    isKeyframeActive(55) ? "text-cyan-400 drop-shadow-[0_0_8px_#22d3ee] scale-125" : "text-neutral-600 hover:text-white"
                  )}
                  style={{ left: "55%" }}
                >
                  ◆
                ...
                <span
                  className={cn("absolute text-[12px] font-extrabold transition-all duration-300 font-sans cursor-pointer",
                    isKeyframeActive(85) ? "text-cyan-400 drop-shadow-[0_0_8px_#22d3ee] scale-125" : "text-neutral-600 hover:text-white"
                  )}
                  style={{ left: "85%" }}
                >
                  ◆
                ...
                <div className="absolute inset-y-0.5 left-2 right-2 flex items-center justify-between opacity-40">
                  {Array.from({ length: 28 }).map((_, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={cn("w-[2px] rounded-sm transition-all duration-100", isPlaying ? "bg-green-500" : "bg-neutral-700")}
...
const editServices = [
  { icon: Scissors, title: "Short-Form Edits", description: "Reels, TikToks, Shorts — hook-first pacing built around the critical first 0.8 seconds to maximize scroll-stopping power." },
  { icon: Clapperboard, title: "Long-Form & Podcasts", description: "Retention-graphs guide every cut, b-roll placement and chapter marker. We keep viewers watching to the end." },
  { icon: Wand2, title: "VFX & Motion Graphics", description: "Tracked text, seamless transitions and motion graphics that feel premium — without the Hollywood timeline or budget." },
  { icon: Music2, title: "Sound Design", description: "Mix, master, SFX layers and music selection — audio is never an afterthought. Every frame sounds as good as it looks." },
  { icon: Film, title: "Cinematic Color Grade", description: "Film-grade color science tuned to your brand palette and platform. Consistent, cinematic looks across every deliverable." },
  { icon: Zap, title: "Content Repurposing", description: "One shoot, twenty deliverables. We natively adapt your content across platforms — no lazy crops, no letterboxing." },
];

function ServiceCard({ icon: Icon, title, description, index }: { icon: React.ElementType; title: string; description: string; index: number }) {
    ...
    <section id="services" className="relative w-full overflow-hidden px-4 sm:px-6 md:px-8 py-12 md:py-20 bg-white dark:bg-black">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="flex flex-col items-center text-center mb-8 md:mb-12">
          ...
          >
            From raw footage to scroll-stopping content — every frame is precision-cut for maximum impact.
          </motion.p>
        </div>
...
const editItems = [
  ...
  },
  {
    ...
    poster: "https://framerusercontent.com/images/JZOcw2Qtn21puWJbHgarML3XE.png?width=260&height=462",
  ...
  },
  {
    ...
    poster: "https://framerusercontent.com/images/5jOtcgkwh7AOIWMWAQXhjcUGSuk.png?width=528&height=938",
  ...
  },
  {
    ...
    poster: "https://framerusercontent.com/images/GQAeNbLUrqex9RGI2FfI439LBk.png?width=260&height=462",
  ...
  },
  {
    ...
    poster: "https://framerusercontent.com/images/wwd7Oo6fI1uymPjy9wsEth6V7o.png?width=528&height=938",
  ...
  },
  {
    ...
    poster: "https://framerusercontent.com/images/NtF9fOocoLKR8ft90SP7R6ESM.png?width=260&height=462",
  ...
  },
  {
    ...
    poster: "https://framerusercontent.com/images/v0GaV0fEBKAk5YB6pTctysPxo.png?width=260&height=462",
  ...
  },
  {
    ...
    poster: "https://framerusercontent.com/images/BnuLIU2FE0lmg7cx1EyRcombots.png?width=528&height=938",
...
function Portfolio({ items, title, subtitle, direction = "left" }: PortfolioProps) {
...
function Packages() {
  return (
    <section id="packages" className="relative w-full overflow-hidden px-4 sm:px-6 md:px-8 py-12 md:py-20 bg-white dark:bg-black">
      {/* ambient background */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0"
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="flex flex-col items-center text-center mb-10 md:mb-14">
          ...
          <motion.p
            ...
            className="mt-6 max-w-2xl text-lg md:text-xl text-neutral-600 dark:text-neutral-400 font-medium"
          >
            Pick the plan that fits your content volume. Scale up or down anytime — no contracts, no lock-ins.
          </motion.p>
        </div>
        ...
        >
          Need something custom? <a href="#contact" className="text-[#ff4d31] font-semibold hover:underline">Let's talk →</a>
        </motion.p>
      </div>
    </section>
  );

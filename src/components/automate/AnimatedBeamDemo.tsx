    ...
    >
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Circle ref={div4Ref} className="size-16 border-[#ea4b71]/50 bg-[#ea4b71]/5 dark:bg-[#ea4b71]/10">
            <Icons.n8n />
          </Circle>
          <Circle ref={div6Ref} className="border-[#10b981]/50 bg-[#10b981]/5 dark:bg-[#10b981]/10">
            <Icons.openai />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
      ...
      <AnimatedBeam
        ...
        curvature={-75}
        endYOffset={-10}
        gradientStartColor="#ea4b71"
        gradientStopColor="#ff6b8b"
      />
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={div2Ref}
